...
# Based on: https://cgnicholls.github.io/reinforcement-learning/2017/03/27/a3c.html
import os
import sys, getopt
import threading
...
def a3c(num_threads=8, restore=None, save_path='model'):
    processes = []
    envs = []
    ...
    with tf.Session() as sess:
        agent = Agent(session=sess, action_size=envs[0].action_size, optimizer=tf.train.AdamOptimizer(INITIAL_LEARNING_RATE))
...
def main(argv):
    ...
    a3c(num_threads=NUM_THREADS, restore=restore,save_path=save_path)
